...
1. O app começa na tela de splash
2. Depois de alguns segundos, vai para o login
3. O usuário pode:
...
5. Depois volta para o login
6. Faz login com os dados cadastrados
7. Se der certo, entra na tela home
